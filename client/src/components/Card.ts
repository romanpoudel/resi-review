class Card extends HTMLElement {
	constructor() {
		...
		this.innerHTML = `
    <div class="card">
		<a href="${baseURL}src/views/details/index.html?${this.getAttribute("city")}">
						...
						<div class="card__desc">
							...
							<rating-component star="${this.getAttribute(
								"star"
							)}" review="${this.getAttribute(
			"review"
		)}" price="${this.getAttribute("price")}"></rating-component>
						</div>
						</a>
					</div>
  `;
